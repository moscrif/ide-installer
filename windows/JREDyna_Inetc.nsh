...
downloadJRE:
  ;--- DetailPrint "Download JRE" ;---"About to download JRE from ${JRE_URL}"
  Inetc::get "${JRE_URL}" "$TEMP\jre_Setup.exe" /END
  Pop $0 # return value = exit code, "OK" if OK
  DetailPrint "Download result :  $0"

  strcmp $0 "OK" downloadsuccessful
  MessageBox MB_OK "Error: $0" ;--"There was a problem downloading required component - Error: $0"
  abort
downloadsuccessful:
...
ExitInstallJRE:
  Pop $1
  MessageBox MB_OK "Executable JRE returned exit code. Installation aborted." ;  ;"Unable to install Java - Setup will be aborted$\n$\n$1"
  DetailPrint "Executable JRE returned exit code. Installation aborted." ;
  Pop $1 	; Restore $1
  Pop $0 	; Restore $0
  Abort
End:
